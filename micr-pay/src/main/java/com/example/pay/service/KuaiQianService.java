...
import com.example.pay.util.HttpUtil;
import com.example.pay.util.Pkipair;
...
public class KuaiQianService {
    ...
    public boolean addRecharge(Integer uid, BigDecimal rechargeMoney, String orderId) {
        ...
        record.setRechargeStatus(Constants.RECHARGE_STATUS_PROCESSING);
    ...
    private String generateOrderId() {
        ...
        String key = RedisKeys.KEY_RECHARGE_ORDERID;
    ...
    public void addOrderIdToRedis(String orderId) {
        String key = RedisKeys.KEY_ORDERID_SET;
    ...
    public void kqNotify(HttpServletRequest request) {
        ...
        //删除redis中的订单记录
        stringRedisTemplate.boundZSetOps(RedisKeys.KEY_ORDERID_SET).remove(orderId);
    }
    ...
    public void handleQueryOrder() {
        ...
        Set<String> orders = stringRedisTemplate
                .boundZSetOps(RedisKeys.KEY_ORDERID_SET).range(0, -1);
